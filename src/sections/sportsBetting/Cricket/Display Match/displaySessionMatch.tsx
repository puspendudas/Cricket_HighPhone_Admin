        ...
        <Box p={2}>
            ...
            <Grid container spacing={2} mt={2}>
                ...
                <Grid item xs={12} md={5}>
                    <TableContainer component={Paper} sx={{ mt: { xs: 2, md: 0, }, boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)' }}>
                        <Table>
                            <TableHead>
                                <TableRow>
                                ...
                                <TableRow>
                                    <TableCell style={{ padding: 0 }} colSpan={6}>
                                        <Collapse in={open} timeout="auto" unmountOnExit>
                                            ...
                                            <Box mt={2} display="flex" flexWrap="wrap" p={2} gap={1} justifyContent="center">
                                                {[
                                                    { main: 800, sub: 238 },
                                                    { main: -800, sub: 238 },
                                                    { main: 800, sub: 238 },
                                                    ...
                                                    >
                                                        {item.main} <span style={{ color: '#000', backgroundColor: '#fff', borderRadius: '50%', padding: '4px 6px', marginLeft: '4px' }}>{item.sub}</span>
                                                    </Box>
                                                ))}
                                            </Box>
                                        </Collapse>
